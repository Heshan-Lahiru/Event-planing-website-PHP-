...
Event Planning
  ...
  <img style="width:50%; height:500px;" src="https://static.vecteezy.com/system/resources/previews/013/266/662/original/funeral-ceremony-in-grave-of-sad-people-in-black-clothes-standing-and-wreath-around-coffin-in-flat-cartoon-hand-drawn-template-illustration-vector.jpg" alt="Description of the GIF">
</center> 
...
$stmt = $conn->prepare("SELECT * FROM funaral");
$stmt->execute();
