...
$sql = "SELECT * FROM stages WHERE user_id = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("i", $user_id);
$stmt->execute();
$result = $stmt->get_result();
...
$sql = "DELETE FROM stages WHERE user_id = ? AND stages_id = ?";
$stmt = $conn->prepare($sql);
...
?>              <div class="card-info">
                ...
                <form action="" method="post">
                                        <input type="hidden" name="stages_id" value="<?php echo $item_id; ?>">
