...
Event Planning
  ...
  <img style="width:70%; height:700px;" src="https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/61fae657983099.59eb3a814f174.gif" alt="Description of the GIF">
</center> 
...
$stmt = $conn->prepare("SELECT * FROM flower");
$stmt->execute();
