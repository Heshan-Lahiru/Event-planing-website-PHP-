  ...
  <body>
    ...
    <?php endif; ?>
        ...
        <div class="games">
          ...
          <a href="weddingadd.php">  <div class="card">
       <h2>Wedding events</h2>
    </div></a>
    <a href="funaral.php"><div class="card">
       <h2>Funeral events</h2>
    </div></a>
    <a href="birthday.php"><div class="card">
       <h2>Birthday events</h2>
    </div></a>
    <a href="party.php"><div class="card">
       <h2>Party events</h2>
    </div></a>
    <a href="flower.php"><div class="card">
       <h2>Flower Decoration</h2>
    </div></a>
    <a href="stages.php"><div class="card">
       <h2>Stages Rent</h2>
    </div></a>
